...
# LFW related
config.DATASET.LFW_PATH = 'data_occ/datasets/lfws/lfw_retina_112/'
...
config.DATASET.LFW_OCC_PATH ='data_occ/lfws/random_block_id_fill_1/'
config.DATASET.LFW_PAIRS ='data_occ/datasets/lfws/pairs.txt'
